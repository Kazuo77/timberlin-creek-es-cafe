...
export default (config: { mode: string; }) => {
  ...
  return defineConfig({
    plugins: [
      ...
      VitePWA({
        base: '/otis-a-mason-es-cafetorium/',
        ...
        manifest: {
          ...
          // Since the VitePWA `base` property is set to /otis-a-mason-es-cafetorium/
          // the path will resolve to https://ip/otis-a-mason-es-cafetorium/assets/vite.png
          icons: [
            {
              src: './assets/vite.png',
              sizes: '800x800',
          ...
          // The src property is relative to the index.html path at runtime.
          // Since the VitePWA `base` property is set to /otis-a-mason-es-cafetorium/
          // the path will resolve to https://ip/otis-a-mason-es-cafetorium/assets/screenshot_something.png
          screenshots: [
            {
